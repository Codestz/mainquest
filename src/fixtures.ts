...
export const FIXTURES: Fixture[] = [
  {
    ...
    raw: { commits: 2400, reviews: 18, merges: 90, streak: 140, repos: 6, issues: 20 },
  ...
  },
  {
    ...
    raw: { commits: 210, reviews: 640, merges: 70, streak: 40, repos: 14, issues: 190 },
    accountAgeYears: 9, prsOpened: 55, weeks: wave(11, 34), restricted: 0,
  },
  {
    login: 'brand-new', note: 'account created this campaign',
    raw: { commits: 34, reviews: 0, merges: 2, streak: 6, repos: 2, issues: 1 },
  ...
  },
  {
    ...
    raw: { commits: 40, reviews: 12, merges: 5, streak: 9, repos: 3, issues: 4 },
  ...
  },
  {
    ...
    raw: { commits: 0, reviews: 0, merges: 0, streak: 0, repos: 0, issues: 0 },
